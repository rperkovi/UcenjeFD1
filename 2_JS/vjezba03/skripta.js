...
console.log('Osijek' === 'osijek')
console.log( 5 === '5')
console.log('Edunova' === 'Druga skola')
...
const {prezime, ...obijektBezPrezimena} = polaznik
console.log(obijektBezPrezimena)
console.log(prezime)


let sifra = null
console.log(sifra ?? 'Šifra nije postavlje'

to to HTMLFontElement,.
...
console.log('prezime' in obijektBezPrezimena)
